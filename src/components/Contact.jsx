    ...
    <div className="md:px-10 px-7 my-10" id="contact">
      ...
      <div className="flex ">
        ...
        <div className="md:w-1/2">
            ...
            <form>
                <input type="text" name="name" placeholder="Name:" className="bg-primary bg-opacity-10 py-3 px-3 md:w-3/4 w-full rounded  "/>
                <input type="email" name="email" placeholder="Email:" className="bg-primary bg-opacity-10 py-3 px-3 md:w-3/4 w-full rounded my-3"/>
                ...
                <button className="btn transition-all duration-500 bg-primary py-2 px-12 rounded text-green hover:bg-yellow hover:text-white block">
                  Send
                </button>
            </form>
        </div>
